...
public class TeamHome {
    ...
    private TeamHome(@NotNull Location location, @Nullable String server) {
        this.server = server;
    ...
    public static TeamHome of(@NotNull Location location, @Nullable String server) {
        return new TeamHome(location, server);
    }
